...
<div class="container">
    <div class="row">
        <div class="col-md-12"><br>
            ...
            <table id="TableRecordList" class="table table-striped table-hover table-bordered">
                <thead>
                <tr>
                    <th>ลำดับ</th>
                    <th>ชื่อร้าน</th>
...
<script>
    $(document).ready(function () {
        let dataRecords = $('#TableRecordList').DataTable({
            ...
            'serverMethod': 'post',
            'ajax': {
                'url': 'model/sac_lotto_show_process.php',
                'data': function (d) {
                    d.action = "GET_LOTTO_SHOW";
                    d.sub_action = "GET_MASTER";
                    d.start = d.start; // ส่งค่า start ไปยัง PHP
                    d.length = d.length; // ส่งค่า length ไปยัง PHP
                }
            },
            'columns': [
                {data: 'order_no'},
